    ...
    <div style="font-family: Arial, sans-serif; color: #333;">
      ...
      ${existingUser
            ? `<p>Click below to accept the invitation and join the group:</p>
             <a href="${acceptLink}" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px;">Accept Invitation</a>`
            : `<p>You don't have an account yet. Join <strong>ExpenX</strong> to manage and share group expenses effortlessly.</p>
             ...
             <a href="https://yourapp.com/signup?redirect=${encodeURIComponent(
                acceptLink
